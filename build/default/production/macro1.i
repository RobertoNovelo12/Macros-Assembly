...
secuencia_leds:
    ...
    SET_PIN PORTB, 0 ; Enciende LED en ((PORTB) and 07Fh), 0
    CALL delay ; Llama a rutina de retardo
    CLEAR_PIN PORTB, 0 ; Apaga LED en ((PORTB) and 07Fh), 0

    SET_PIN PORTB, 1 ; Enciende LED en ((PORTB) and 07Fh), 1
    CALL delay ; Llama a rutina de retardo
    CLEAR_PIN PORTB, 1 ; Apaga LED en ((PORTB) and 07Fh), 1

    SET_PIN PORTB, 2 ; Enciende LED en ((PORTB) and 07Fh), 2
    CALL delay ; Llama a rutina de retardo
    CLEAR_PIN PORTB, 2 ; Apaga LED en ((PORTB) and 07Fh), 2

    SET_PIN PORTB, 3 ; Enciende LED en ((PORTB) and 07Fh), 3
    CALL delay ; Llama a rutina de retardo
    CLEAR_PIN PORTB, 3 ; Apaga LED en ((PORTB) and 07Fh), 3
